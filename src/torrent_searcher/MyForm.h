...
private: System::Void button2_Click(System::Object^  sender, System::EventArgs^  e) {
			 if(textBox2->Text != ""){
				 switch(comboBox1->SelectedIndex){
					 case 0:
						IO::File::WriteAllText("brw.bat", "cd C:\\Program Files (x86)\\Mozilla Firefox\nfirefox.exe"+" -url http://rutor.info/search/0/0/000/0/" + textBox2->Text);
					 break;
					 case 1:
						IO::File::WriteAllText("brw.bat", "cd C:\\Program Files\\Opera\nlauncher.exe"+" -url http://rutor.info/search/0/0/000/0/" + textBox2->Text);
					 break;
				 }
				 system("brw");
			 }
